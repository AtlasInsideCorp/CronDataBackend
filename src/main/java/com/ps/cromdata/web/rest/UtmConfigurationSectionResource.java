...
import com.ps.cromdata.service.UtmConfigurationSectionQueryService;
import com.ps.cromdata.service.UtmConfigurationSectionService;
import com.ps.cromdata.service.dto.UtmConfigurationSectionCriteria;
...
public class UtmConfigurationSectionResource {
    ...
    public ResponseEntity<UtmConfigurationSection> updateUtmConfigurationSection(@RequestBody UtmConfigurationSection utmConfigurationSection) throws URISyntaxException {
        ...
        return ResponseEntity.ok()
            .headers(HeaderUtil.createEntityUpdateAlert("CRONDATA", true, ENTITY_NAME, utmConfigurationSection.getId().toString()))
            .body(result);
    }
